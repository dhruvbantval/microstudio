...
this.Session = (function() {
  function Session(server, socket) {
    ...
    this.register("read_component_data", (function(_this) {
      return function(msg) {
        return _this.readComponentData(msg);
      };
    })(this));
  ...
  Session.prototype.readComponentData = function(data) {
    var dbData, dbPath, error, fs, parsedData, path;
    if (this.user == null) {
      return this.sendError("not connected");
    }
    fs = require('fs');
    ...
    try {
      ...
      return this.sendError('Failed to read component data');
    }
  };
