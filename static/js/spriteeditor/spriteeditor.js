...
(function() {
  this.SpriteEditor = class SpriteEditor extends Manager {
    constructor(app) {
      ...
      document.getElementById("import-component-data-button").addEventListener("click", (event) => {
        return this.importComponentData();
      });
    ...
    createObjectQueryUI() {
      ...
      if (container && !document.getElementById("object-query-ui")) {
        uiContainer = document.createElement("div");
        uiContainer.id = "object-query-ui";
        uiContainer.style.cssText = `position: absolute;
top: 10px;
right: 10px;
...
">Ready for queries...</div>`;
        ...
        return document.getElementById("object-id-input").addEventListener("keypress", (event) => {
          if (event.key === "Enter") {
            return this.queryObjectData();
          }
        });
